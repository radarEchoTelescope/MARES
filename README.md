This branch will track the implementation of sparse matrices in MARES. This is useful when saving a lot of 2D output files that have often a lot of redundant zeros in them. The package we will use is Eigen C++ https://eigen.tuxfamily.org/index.php?title=Main_Page
